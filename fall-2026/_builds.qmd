...
| **4** &nbsp;Ethical and legal obligations | Your project's IRB and DUA checklist, signed by every member: whether it needs an IRB application, whether any data source needs a data-use agreement, and the date the slowest gate has to start |
| **5** &nbsp;Using AI in research | Your candidate dataset interrogated — or, if you do not hold one yet, the named access route and plan B for getting it |
