...
| **4** &nbsp;Ethical and legal obligations | Your project's ethics-and-access checklist, signed by every member: whether it needs an IRB application, whether any data source needs a data-use agreement, and the date the slowest gate has to start |
