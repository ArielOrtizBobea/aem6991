...
**Statement of interest**, one page maximum, in five sections: the context,
the problem, your proposition, its feasibility and challenges, and why you
— what you bring, and how this fits where you want to go professionally.
The first four are the research proposal's own skeleton, scaled down. The
fifth is how teams get matched.
...
Statement of interest — **one page maximum**, due before meeting 2 on
September 2.

| | |
|:--|:--|
| 1 · Context | What world is this in? |
| 2 · The problem | What is wrong, unknown, or stuck? |
| 3 · Your proposition | What would you do about it? |
| 4 · Feasibility | What data, and what could stop it? |
| 5 · Why you | What you bring — a job, an industry, a language, access
  to somebody. And why this fits where you want to go |

Section 4 is largely what your group told you this afternoon. Use it.

::: {.notes}
Last thing they hear, so land it. Say the deadline twice, and say one page
means one page.

Sections 1 to 4 are the proposal's own skeleton, scaled down — they will
write these same headings again in November, which is worth telling them.

Section 5 is how I match teams, and it is two things. What you bring is
capability — without it I can only match on topic, and five people with the
same background is a worse team. Why this fits where you want to go is
