...
Everyone completes CITI training, whether or not their project needs it,
because the IRB issues nothing until every person on a protocol has
finished.
:::

## Due

In session B, your project's ethics-and-access checklist, signed by every
member: does it need an IRB application, and does any data source need a
data-use agreement. Before meeting 6, Wednesday September 30, your CITI
human-participants training certificate on Canvas.
...
- The commission's Belmont Report of 1979 set out three principles, and each comes with a practice:
...
- An IRB applies the three principles before a study starts, and every university that takes federal research money has one.
- The principles do not depend on who pays: a firm's survey of its own customers has no board and the same obligations.
:::
...
The last bullet is for the people in this room who will run research
inside a firm, which is most of them. AOL posted 20 million search queries
for researchers in 2006; a user was identified by name within days, the
chief technology officer resigned and two employees were fired. Nobody at
AOL needed an IRB to lose those jobs. Three habits travel anywhere: ask
people where you can, collect the minimum, and have somebody with no stake
read the plan.
:::
...
is the page on the slide. The journal said a private company was under no
obligation to follow the Common Rule, and then said it was concerned
anyway. Cornell said its professor and his graduate student had access only
to results, so its board never reviewed it. Facebook announced review
guidelines and a panel that October.
...
## CITI training is required of everyone
...
- You do not know yet whether your project will need it, and one teammate who skipped it holds up the whole team.
- So everyone in this course completes it, whether or not their project involves people.
- The course takes two to four hours, and the certificate goes on Canvas before meeting 6, Wednesday September 30.
...
room. It is the one thing in this part that applies to everyone.
...
The certificate lasts five years. Not there by then costs five
...
::: {.notes}
Two minutes. The case that opens the third part, because it is a
data-agreement failure from end to end. Data collected under one purpose,
research, and passed to a third party against the platform's terms. A
certificate of deletion that was false. And a price paid by the platform,
the firm and the developer.
...
regulated. So a company's A/B test needs no board, and a firm with no board
is not a firm with no ethics: the principles do not depend on who pays, and
the consequences arrive without a board, as they did for
[AOL in 2006](https://www.nbcnews.com/id/wbna14231664).
...
Americans uniquely, Netflix's anonymised ratings were
...
exempt protocols included. So the training is required of everyone in this
course, whether or not their project involves people. Upload the certificate
to Canvas before meeting 6, Wednesday September 30.
...
exist is a fabrication, whoever or whatever produced it. Francesca Gino is
the falsification case: rows moved between conditions, found from the
metadata inside an Excel file, and tenure revoked in 2025.

Then the practices the National Academies call detrimental, which fall
short of misconduct and are far more common: p-hacking, HARKing, selective
...
numbers, after publication, and the price was usually the job. Publications
per year from OpenAlex are on the Stapel, Gino and Wansink slides, with the
year each case broke marked. And the one that is live in this room: two New
...
The section opens with Cambridge Analytica. A Cambridge psychologist's
quiz app, installed by about 270,000 people and described as a research
app, also took data from the installers' friends. The data went to
Cambridge Analytica against Facebook's platform policy;
[up to 87 million profiles](https://about.fb.com/news/2018/04/restricting-data-access/)
were reached, and the certificates that the data had been deleted were
false. The price was a
...
on Facebook in 2019, and the chief executive before Congress. Three more
cases where data was used beyond what was agreed: blood given by the
...
stops. The honesty-pledge paper carries no chart, because a chart titled
...
you are proposing, answered on the ethics-and-access checklist and signed
by every member.
...
**Homework.** CITI human-participants training, with the certificate on
Canvas before meeting 6, Wednesday September 30. Everyone, whether or not
the project involves people.

## Handouts

[Ethics-and-access checklist](../handouts/ethics-checklist.qmd). The two
